            ...
            <ul className="space-y-0.5">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm text-white/60 hover:text-gold transition-colors duration-200 min-h-[44px]"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-sm text-white/60 hover:text-green-wa transition-colors duration-200 min-h-[44px]"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 shrink-0">
              ...
              <li className="text-sm text-white/50 pt-3">
