...
const reasons = [
  {
    ...
    description:
      'Hand-selected timber and graded plywood. We never compromise on material quality — every piece meets our standards.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Three decades in the timber business means we understand construction needs, material grades, and fair market pricing.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    title: 'Fast Delivery',
    description:
      'Serving 50+ areas across Lahore with same-day delivery on in-stock items, and bulk dispatch nationwide across Pakistan — straight to your construction site.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    title: 'Fair Pricing',
    description:
      'Transparent pricing with no hidden charges. We offer competitive rates and honest measurements you can trust.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-cream-dark/30">
              <Image
                src="/images/plywood-godown-lahore.jpg"
                alt="Film-coated plywood stacked in the Lala G godown, Lahore"
                fill
