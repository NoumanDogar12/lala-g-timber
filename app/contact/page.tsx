            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-black/[0.06] p-6">
                ...
                <a
                  ...
                  className="text-2xl font-bold text-wood hover:text-gold-dark transition-colors inline-flex items-center min-h-[44px]"
                >
              ...
              <div className="bg-white rounded-xl border border-black/[0.06] p-6">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-green-wa font-semibold hover:opacity-80 transition-opacity min-h-[44px]"
                >
