...
const priceCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Duraplex 16mm (8x4)', unit: 'per sheet' },
      { name: 'Duraplex 18mm (8x4)', unit: 'per sheet' },
      { name: 'Korenplex 16mm (8x4)', unit: 'per sheet' },
      { name: 'Korenplex 18mm (8x4)', unit: 'per sheet' },
      { name: 'Smart 16mm (8x4)', unit: 'per sheet' },
      { name: 'Smart 18mm (8x4)', unit: 'per sheet' },
      { name: 'Greenplex 16mm (8x4)', unit: 'per sheet' },
      { name: 'Greenplex 18mm (8x4)', unit: 'per sheet' },
      { name: 'Kite 16mm (8x4)', unit: 'per sheet' },
      { name: 'Kite 18mm (8x4)', unit: 'per sheet' },
      { name: 'Royalplex 16mm (8x4)', unit: 'per sheet' },
      { name: 'Royalplex 18mm (8x4)', unit: 'per sheet' },
    ],
  },
  {
